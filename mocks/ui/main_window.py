...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout_2.addWidget(self.helpAccountButton, 0, 4, 1, 1)
        self.serverConnectionStatusTextLabel = QtGui.QLabel(self.gridLayoutWidget)
        self.serverConnectionStatusTextLabel.setMinimumSize(QtCore.QSize(0, 50))
        self.serverConnectionStatusTextLabel.setMaximumSize(QtCore.QSize(16777215, 50))
        self.serverConnectionStatusTextLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.serverConnectionStatusTextLabel.setObjectName(_fromUtf8("serverConnectionStatusTextLabel"))
        self.gridLayout_2.addWidget(self.serverConnectionStatusTextLabel, 0, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.helpSignalSourceButton, 0, 3, 1, 1)
        ...
        self.runDemodulatorButton.setIcon(icon4)
        ...
        self.gridLayout_7.addWidget(self.helpCloudUploadButton, 0, 7, 1, 1)
        self.sendFramesToCloudButton = QtGui.QPushButton(self.gridLayoutWidget_5)
        self.sendFramesToCloudButton.setMinimumSize(QtCore.QSize(0, 50))
        self.sendFramesToCloudButton.setMaximumSize(QtCore.QSize(16777215, 50))
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/cloud-upload/img/cloud-upload-alt-solid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sendFramesToCloudButton.setIcon(icon5)
        self.sendFramesToCloudButton.setIconSize(QtCore.QSize(35, 35))
        self.sendFramesToCloudButton.setObjectName(_fromUtf8("sendFramesToCloudButton"))
        self.gridLayout_7.addWidget(self.sendFramesToCloudButton, 0, 4, 1, 1)
        ...
        self.loadFramesFromFileButton.setIcon(icon6)
        ...
        self.autoUploadToolButton.setIcon(icon7)
        ...
        self.gridLayout_7.addWidget(self.autoUploadToolButton, 0, 3, 1, 1)
        ...
        self.framesListWidget.setMinimumSize(QtCore.QSize(520, 360))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.credentialsButton.setToolTip(_translate("mainWindow", "Choose a new credentials file...", None))
        self.credentialsButton.setText(_translate("mainWindow", "Choose credentials file", None))
        ...
        self.sendFramesToCloudButton.setToolTip(_translate("mainWindow", "Send frames from the list to cloud", None))
        self.sendFramesToCloudButton.setText(_translate("mainWindow", "Send Frames To Cloud", None))
        ...
        self.autoUploadToolButton.setToolTip(_translate("mainWindow", "Upload frames to cloud automatically", None))
        self.autoUploadToolButton.setText(_translate("mainWindow", "Auto Send Frames", None))
