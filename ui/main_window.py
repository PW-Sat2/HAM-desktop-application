...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout_2.addWidget(self.serverConnectionStatusIconLabel, 0, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.serverConnectionStatusTextLabel, 0, 4, 1, 1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/help/img/question-solid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.helpAccountButton.setIcon(icon2)
        self.helpAccountButton.setIconSize(QtCore.QSize(35, 35))
        self.helpAccountButton.setObjectName(_fromUtf8("helpAccountButton"))
        self.gridLayout_2.addWidget(self.helpAccountButton, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.credentialsLoadButton, 0, 1, 1, 1)
        ...
        self.helpSignalSourceButton.setIcon(icon2)
        ...
        self.helpDemodulatorButton.setIcon(icon2)
        ...
        self.helpCloudUploadButton.setIcon(icon2)
        ...
        self.gridLayout_7.addWidget(self.helpCloudUploadButton, 0, 5, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/auto-upload-offline/img/cloud-upload-alt-solid-disabled.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/cloud-upload/img/cloud-upload-alt-solid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/cloud-upload/img/cloud-upload-alt-solid.svg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/cloud-upload/img/cloud-upload-alt-solid.svg")), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/cloud-upload/img/cloud-upload-alt-solid.svg")), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        self.autoUploadToolButton.setIcon(icon5)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/cloud-upload/img/cloud-upload-alt-solid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sendUnsuccessfulButton.setIcon(icon7)
        ...
        self.gridLayout_7.addWidget(self.sendUnsuccessfulButton, 0, 3, 1, 1)
