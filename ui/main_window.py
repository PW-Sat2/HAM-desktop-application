...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout_2.addWidget(self.helpAccountButton, 0, 5, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/load-frames/img/file-import-solid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.loadFramesFromFileButton.setIcon(icon5)
        ...
        self.sendFramesToCloudButton.setIcon(icon7)
        ...
        self.gridLayout_7.addWidget(self.sendFramesToCloudButton, 0, 3, 1, 1)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.credentialsButton.setText(_translate("mainWindow", "michal.gumiela@gmail.com", None))
