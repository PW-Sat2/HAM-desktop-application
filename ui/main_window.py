...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout_2.addWidget(self.helpAccountButton, 0, 7, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/credentials/img/key-solid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.credentialsLoadButton.setIcon(icon3)
