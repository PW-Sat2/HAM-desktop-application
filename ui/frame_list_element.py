...
class UiFrameListWidget(QtGui.QWidget):
    def __init__ (self, parent=None):
        ...
        self.gridLayout.addWidget(self.downlinkIconLabel, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.uuidValueLabel, 0, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frameTypeLabel, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.uploadStatusIconButton, 0, 4, 1, 1)
